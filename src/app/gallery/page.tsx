  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
        ...
        <main className="flex-1">
            <section className="text-center py-20 px-4 border-b border-white/10 bg-secondary/30">
                ...
                {isLoadingGallery ? (
                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {galleryItems.map(item => (
                            <Card key={item.id} className="flex flex-col bg-secondary/50 border-white/10 overflow-hidden">
